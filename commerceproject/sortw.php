...
$sort=$_GET['trier'];
if($sort=='DESC'){
$sql2 ="SELECT * FROM product where categorie='pc' AND type='windows' order BY Price DESC";
$conn = mysqli_connect($servername, $username, $password,$db);
...
if($sort=='ASC'){
$sql2 ="SELECT * FROM product where categorie='pc'AND type='windows' order BY Price ASC";
$conn = mysqli_connect($servername, $username, $password,$db);
$result = mysqli_query($conn, $sql2);
mysqli_close($conn);
...
<div class="">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item "><a href="pc.php" style="text-decoration:none; color:black;">Ordinateurs</a></li>
...
$(".cr").click(function(){
window.location.href="sortw.php?trier=ASC ";
  });   
$(".dec").click(function(){
window.location.href="sortw.php?trier=DESC ";
  });      
