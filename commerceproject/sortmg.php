...
if($sort=='DESC'){
$sql2 ="SELECT * FROM product where categorie='pc' AND type='gaming' AND mark IN($fin) order BY Price DESC";
$conn = mysqli_connect($servername, $username, $password,$db);
$result = mysqli_query($conn, $sql2);
mysqli_close($conn);
}
if($sort=='ASC'){
  $sql2 ="SELECT * FROM product where categorie='pc'AND type='gaming' AND mark IN($fin) order BY Price ASC";
$conn = mysqli_connect($servername, $username, $password,$db);
$result = mysqli_query($conn, $sql2);
mysqli_close($conn);
}
...
<div class="">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"  aria-current="page"><a href="windows.php" style="text-decoration:none; color:black;">Gaming </a> </li>
...
window.location.href="sortmg.php?fin= <?php echo $fin?>&trier=ASC&brand=<?php  echo $brand?> ";
  });      
  $(".decroissant").click(function(){
window.location.href="sortmg.php?fin= <?php echo $fin?>&trier=DESC&brand=<?php  echo $brand?> ";
  });     
