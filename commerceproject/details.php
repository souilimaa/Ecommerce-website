...
if($sort=='DESC'){
$sql2 ="SELECT * FROM product where categorie='pc' AND mark IN($fin) order BY Price DESC";
$conn = mysqli_connect($servername, $username, $password,$db);
$result = mysqli_query($conn, $sql2);
mysqli_close($conn);
}
if($sort=='ASC'){
  $sql2 ="SELECT * FROM product where categorie='pc' AND mark IN($fin) order BY Price ASC";
$conn = mysqli_connect($servername, $username, $password,$db);
$result = mysqli_query($conn, $sql2);
mysqli_close($conn);
}
...
<form action="marque.php"  method="GET">
...
<div class="form-check">
  <input class="form-check-input" type="checkbox" name="brand[]" value="Apple" id="flexCheckDefault">
...
<div class="form-check mb-2" >
  ...
  <div class="pc mt-3 ms-sm-2 ms-md-4 ms-col-1"> 
...
window.location.href="details.php?fin= <?php echo $fin?>&trier=ASC&brand=<?php  echo $brand?> ";
  });      
  $(".decroissant").click(function(){
window.location.href="details.php?fin= <?php echo $fin?>&trier=DESC&brand=<?php  echo $brand?> ";
  });     
