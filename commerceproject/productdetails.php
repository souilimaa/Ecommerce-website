...
$result = mysqli_query($conn, $sql);
 ...
 $sql2="SELECT * FROM solde WHERE id=$id";
...
<link rel="icon" href="images/favicon.ico" type="image/ico">  
	<title><?php echo $title ?>|TechShop</title>
...
<li class="breadcrumb-item"><a href="<?php echo $type ?>.php" style="text-decoration:none; color:black;"><?php echo $type ?></a></li>
...
<div class="card  m-5" style="">    
  <div class="row g-0">     
    <div class="col-md-5 ">
      <img  style="height: 450px; width: 480px;" src="<?php echo $image ?>" class="img-fluid rounded-start " alt=""    >
    </div>  
    <div class="col-md-7">
      <div class="card-body "  >
      	 <div class="card-title" style="color: gray;"><?php echo $mark?></div>
        <h3 class="card-title"><?php echo $title ?></h3>
      
        <h4 class="card-text"><?php echo $price ?> <span style="" >MAD</span></h4>
        <hr>
  
  
      <div class="m-1 card-text" style="color:#4693d1;"><h5>Details</h5></div>

  <pre class="card-text des" ><h5><?php echo $description ?></h5>
  
       </pre>  

<form method='post' action='' >
    <input type='hidden' name='code' value="<?php  echo $id ?>">
      <button  class="btn btn-primary  card-text cli   w-75" id="ajouter" style="  
 color: white ; border-color:#5d7e99 ; "     type="submit">Ajouter au Panier</button>     
    </form>    
