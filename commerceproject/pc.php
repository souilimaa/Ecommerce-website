...
if (isset($_POST['code']) && $_POST['code']!=""){
  ...
  if(empty($_SESSION['shopping_cart'])){
    ...
    $sql ="SELECT * FROM product where categorie='pc'";
...
<div class="pc mt-3 ms-3 ms-col-1 me-2"> 
  <div class="row row-cols-1  mt-1 ms-1 me-1 row-cols-md-2 
  row-cols-sm-1 row-cols-lg-3 g-4">

  
  <?php  while($row = mysqli_fetch_assoc($result)) { $id=$row['id']; ?>
  <div class="col"> 
      ...
      <div class="card" >
        ...
        <div style="height: 30px;">  
          ...
          while($row2=mysqli_fetch_assoc($resultat)){
            if($row2['stars']==1){?>
             <span style="color: orange;"> <i class="fa-solid fa-star"></i></span>
          ...
          <?php } elseif ($row2['stars']==4) {?>
            <span style="color: orange;"> <i class="fa-solid fa-star"></i></span>
            <span style="color:orange;"><i class="fa-solid fa-star"></i></span>
            <span style="color:orange;"><i class="fa-solid fa-star"></i></span>
            <span style="color:orange;"> <i class="fa-solid fa-star"></i></span>
            <span style="color:grey;"> <i class="fa-solid fa-star"></i></span>
          <?php }  elseif ($row2['stars']==5) {?>
            <span style="color: orange;"> <i class="fa-solid fa-star"></i></span>
            <span style="color:orange;"><i class="fa-solid fa-star"></i></span>
            <span style="color:orange;"><i class="fa-solid fa-star"></i></span>
            <span style="color:orange;"> <i class="fa-solid fa-star"></i></span>
          ...
          <div id="ajouter">
            <form method='post' action='' >
              ...
              <button class="btn btn-primary mt-2 ms-3" style="  
...
<script >
  ...
  $(".cr").click(function(){
    window.location.href="sort.php?trier=ASC ";
  });   
  $(".dec").click(function(){
    window.location.href="sort.php?trier=DESC ";
  });      
