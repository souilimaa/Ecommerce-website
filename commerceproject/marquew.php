...
$keyofsession=array_keys($_SESSION['shopping_cart']);
...
$fin = "'" . $brands . "'";
$sql2 ="SELECT * FROM product where categorie='pc' AND type='windows' AND mark IN($fin)";
$conn = mysqli_connect($servername, $username, $password,$db);
...
<title>Ordinateurs|Windows|TechShop</title>
...
<div class="">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"  aria-current="page"><a href="pc.php" style="text-decoration:none; color:black;">Ordinateurs </a> </li>
    <li class="breadcrumb-item"  aria-current="page"><a href="windows.php" style="text-decoration:none; color:black;">Windows </a> </li>
          <li class="breadcrumb-item active"  aria-current="page"><?php foreach ($brand as $value) {
...
<div class="ms-4 mb-2 mt-3" style="color:#ff2972;">Marque</div>
<div class="ms-5 mt-2">

<form action="marquew.php"  method="GET">
    <div class="checkbox-group required">
<div class="form-check " >
  <input class="form-check-input" type="checkbox"  name="brand[]" value="Dell" id="Dell">
  <label class="form-check-label" for="Dell">
Dell  </label>
</div>
<div class="form-check">
  <input class="form-check-input" type="checkbox" name="brand[]" value="Hp" id="hp">
  <label class="form-check-label" for="hp">
   Hp
  </label>
</div>
<div class="form-check">
  <input class="form-check-input" type="checkbox"  name="brand[]" value="Acer" id="Acer">
  <label class="form-check-label" for="Acer">
  Acer
  </label>
</div>
<div class="form-check">
  <input class="form-check-input" type="checkbox" name="brand[]" value="Asus" id="Asus">
  <label class="form-check-label" for="Asus">
Asus  </label>
</div>
<div class="form-check">
  <input class="form-check-input" type="checkbox" name="brand[]" value="LG" id="lg">
  <label class="form-check-label" for="lg">
LG  </label>
</div>
<div class="form-check">
  <input class="form-check-input" type="checkbox" name="brand[]" value="Lenovo" id="lenovo">
  <label class="form-check-label" for="lenovo">
Lenovo  </label>
</div>
</div>
<input type="submit"  value="OK" style="width: 45px;">
</form>
</div>
 <div class="ms-4 mb-2 mt-3" style="color:#ff2972;">Trier Par</div>
 <div class="ms-3 mt-2">
    <div class="form-check mb-2"> 
  <input  class="croissant" class="form-check-input" type="radio" name="trierbrand"  value="ASC" id="croissant">
  <label  class="croissant" class="form-check-label" for="croissant">
    Prix Croissant
  </label>   
</div>       
<div class="form-check mb-2" >
  
  <input class="decroissant" class="form-check-input" type="radio" name="trierbrand" value="DESC" id="decroissant">
  <label  class="decroissant" class="form-check-label" for="decroissant">
    Prix Décroissant
  </label>
...
<?php  if (mysqli_num_rows($result)==0) { ?>
  <div style="text-align: center;" class="mt-3"> <img src="mindar.png"></div>
<div  class="empty mt-5">
  <div>Aucun Résultat !</div>
<div>Malheureusement , il n'y a pas de résultats disponibles.</div>  
</div>
<?php } else{ ?>
...
window.location.href="sortmw.php?fin= <?php echo $fin?>&trier=ASC&brand=<?php  echo $brands?> ";
  });   
  $(".decroissant").click(function(){
window.location.href="sortmw.php?fin= <?php echo $fin?>&trier=DESC&brand=<?php  echo $brands?> ";
  });   
