...
if($sort=='DESC'){
$sql2 ="SELECT * FROM product where categorie='pc' AND type='windows' AND mark IN($fin) order BY Price DESC";
$conn = mysqli_connect($servername, $username, $password,$db);
$result = mysqli_query($conn, $sql2);
mysqli_close($conn);
}
if($sort=='ASC'){
  $sql2 ="SELECT * FROM product where categorie='pc'AND type='windows' AND mark IN($fin) order BY Price ASC";
$conn = mysqli_connect($servername, $username, $password,$db);
$result = mysqli_query($conn, $sql2);
mysqli_close($conn);
}
...
window.location.href="sortmw.php?fin= <?php echo $fin?>&trier=ASC&brand=<?php  echo $brand?> ";
  });      
  $(".decroissant").click(function(){
window.location.href="sortmw.php?fin= <?php echo $fin?>&trier=DESC&brand=<?php  echo $brand?> ";
  });     
