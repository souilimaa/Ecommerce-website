...
$_SESSION['search']=$searchValue;
    $sql ="SELECT * FROM product where title like '% $searchValue %'";
...
<?php } else{ ?>
  <div style=" display: flex; justify-content: center;   background-color: white;" class="m-5 "> 
    <div>
   <div style="text-align: center;" class="mt-3"> <img src="mindar.png"></div>
<div  class="noresult mt-5 ">


  <div>Aucun Résultat pour "<?php echo $_SESSION['search'] .'"';?> !</div>
...
<div>- Vérifiez que vous n'avez pas fait de faute de frappe : "Lirves" au lieu de "Livres"</div>
<div>- Essayez avec un autre mot clé ou synonyme</div>
</div>     

<button class="vertical-center go btn btn-primary mb-3">RETOUR A L'ACCUEIL</button>
</div>
</div>    
