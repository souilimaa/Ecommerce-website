...
$fin = "'" . $brands . "'";
$sql2 ="SELECT * FROM product where categorie='pc' AND type='gaming' AND mark IN($fin)";
$conn = mysqli_connect($servername, $username, $password,$db);
...
<title>Ordinateurs|Gaming|TechShop</title>
...
<div class="">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"  aria-current="page"><a href="gaming.php" style="text-decoration:none; color:black;">Gaming</a> </li>
...
<form action="marqueg.php"  method="GET">
...
<div class="form-check mb-2" >
  ...
  <?php if (($row = mysqli_fetch_assoc($result))==0) { ?>
...
window.location.href="sortmg.php?fin= <?php echo $fin?>&trier=ASC&brand=<?php  echo $brands?> ";
  });    
  $(".decroissant").click(function(){
window.location.href="sortmg.php?fin= <?php echo $fin?>&trier=DESC&brand=<?php  echo $brands?> ";
  });   
