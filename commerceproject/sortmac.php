...
$sort=$_GET['trier'];
if($sort=='DESC'){
$sql2 ="SELECT * FROM product where categorie='pc' AND type='Macbook' order BY Price DESC";
$conn = mysqli_connect($servername, $username, $password,$db);
...
if($sort=='ASC'){
$sql2 ="SELECT * FROM product where categorie='pc'AND type='Macbook' order BY Price ASC";
$conn = mysqli_connect($servername, $username, $password,$db);
$result = mysqli_query($conn, $sql2);
mysqli_close($conn);
...
<title>Ordinateurs|Macbook|TechShop</title>
...
$(".cr").click(function(){
window.location.href="sortmac.php?trier=ASC ";
  });   
$(".dec").click(function(){
window.location.href="sortmac.php?trier=DESC ";
  });      
