...
$fin = "'" . $brands . "'";
$sql2 ="SELECT * FROM product where categorie='pc' AND mark IN($fin)";
$conn = mysqli_connect($servername, $username, $password,$db);
...
window.location.href="details.php?fin= <?php echo $fin?>&trier=ASC&brand=<?php  echo $brands?> ";
  });   
  $(".decroissant").click(function(){
window.location.href="details.php?fin= <?php echo $fin?>&trier=DESC&brand=<?php  echo $brands?> ";
  });   
